...
export default class KitchenScene extends BaseRoomScene {
  constructor() {
    super('KitchenScene', 'Kitchen', 0xf39c12);
    
    // Configure doors for this room
    this.doorConfigs = [
      {
        x: 400, // Top - to Living Room
        y: 100,
        width: 40,
        height: 80,
  ...
  private addRoomFurniture() {
    ...
    // Add a fridge
    this.add.rectangle(600, 200, 80, 120, 0xffffff, 0.8);
    this.add.text(600, 200, 'FRIDGE', {
      fontFamily: 'Courier, monospace',
      fontSize: '12px',
      color: '#000000'
    }).setOrigin(0.5);
    ...
    // Add a sink
    this.add.rectangle(400, 300, 100, 60, 0xcccccc, 0.8);
    this.add.text(400, 300, 'SINK', {
      fontFamily: 'Courier, monospace',
      fontSize: '12px',
      color: '#000000'
    }).setOrigin(0.5);
